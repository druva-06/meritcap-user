...
interface QuickLoginModalProps {
  ...
  pendingSearchParams?: string // Optional search params to preserve
}

export function QuickLoginModal({ isOpen, onClose, onLoginComplete, pendingSearchParams }: QuickLoginModalProps) {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      if (response.success && response.response?.auth_url) {
        ...
        setError(response.message || "Failed to initiate Google sign-in. Please try again.")
        setLoading(false)
      }
    } catch (err: any) {
      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription className="text-center">
            Sign in quickly with your Google account to search courses
          </DialogDescription>
        </DialogHeader>
